                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="rounded-xs mb-5">
                            <a class="d-block" href="<?php echo e($page_search); ?>">
                                <div class="bg-img-hero gradient-overlay-half-bg-white transition-3d-hover shadow-hover-2 max-height-200" style="background-image: url(<?php echo e(asset('/images/space-background.jpg')); ?>);">
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\BoostAviation\themes/Mytravel/Space/Views/frontend/blocks/term-featured-box/index.blade.php ENDPATH**/ ?>